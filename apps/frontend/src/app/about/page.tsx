export default function AboutPage() {
  return (
    <div className="container mx-auto py-12 px-4 max-w-4xl">
      <h1 className="text-4xl font-bold mb-6">About We Got Jobz</h1>
      <div className="prose dark:prose-invert max-w-none space-y-4">
        ...
        <p>
          We envision a world where anyone with a skill can participate in the global economy and where any company can access the talent they need to grow. We are committed to creating a fair, transparent, and efficient marketplace that empowers both freelancers and clients.
        </p>
        <p>
